...
int main()
{
    ...
    const WhitePointDecision sdr = DecideWhitePoint(0, false, true, true, 8.0f, 1.25f, 0.012f, 1.0f, 1.0f, 12.0f);
    assert(sdr.useGameExposure == 0);
    assert(std::fabs(sdr.whitePoint - 8.0f) <= 1e-4f);
