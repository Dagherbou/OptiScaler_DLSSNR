...
# NoteUiLayer: it is only ever wanted at the finished frame, which is now the only arrangement
...
# the proxy curve's measurement, and the present pass itself
